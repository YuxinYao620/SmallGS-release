...
class Runner:
    ...
    def train(self):
        ...
        for step in pbar:
            ...
            # print("camtoworlds", camtoworlds.requires_grad) #false 
            for i in range(cfg.max_steps):
                ...
                camtoworlds_gt = data["camtoworld_gt"].to(device)  # [1, 4, 4]
                ...
                if cfg.pose_opt:
                    ...
                    print('camto', camtoworlds)
                    print("camto is leaf?", camtoworlds.is_leaf)
                # if True:
                ...
                # forward
                print('camtoworlds', camtoworlds.shape)
                ...
                # self.splats["means"].zero_grad()
                # self.splats["scales"].zero_grad()
                # self.splats["quats"].zero_grad()
                # self.splats["opacities"].zero_grad()
                # if cfg.app_opt:
                #     self.splats["features"].zero_grad()
                #     self.splats["colors"].zero_grad()
                # if cfg.depth_loss:
                #     points.zero_grad()
                #     depths.zero_grad()
                # pixels.zero_grad()
